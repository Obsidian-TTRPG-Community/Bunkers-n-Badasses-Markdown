...
> "Fate "Brings Us Together"? ***She*** got that *from a fanfic* on the ECHO-net!"
...
^BnB-DLC3-Fatemaker-Progression
...
| **4th Wall Break** | Once per Day you can ask the BM a question in-character. Roll `dice: 1d20`+MST Mod. On a 16+, they have to answer. | *Table Talk* |
...
| **Defy Fate** | When your health reaches 0, you can spend 10 Badass Tokens to gain `dice: 3d10` Health. | Lv 20+ |
| **Fatemaker** | Killing an enemy grants you 1 Badass Token. +1 to all Checks. | Lv 20+ |
^BnB-DLC3-Fatemaker-Feats
