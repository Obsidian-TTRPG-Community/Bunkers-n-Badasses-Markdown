...
| Ferocity | **+`dice: 1d6`** Familiar Damage. **+1** /SL on Talk Checks. |
...
| Grim Harvest | Ranged Attacks get **+1** Hit. **+1** Familiar Attack/Turn. **Gamma Burst** deals **+`dice: 1d8`** Damage/SL. |
